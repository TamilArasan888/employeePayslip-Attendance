		...
		<div class="form-attendance">
			<form:form name="form" action="addattendance" method="post"
				...
				<div class="form-control-attendance">
					...
					<form:input type="date" path="attendanceDate" name="attendanceDate" onblur="attendanceDateCheck();"
							placeholder="Enter Attendance Date" required="true" />
				</div>

				<div class="form-control-attendance">
					<label for="inTime">In-Time : </label>
					<form:input path="inTime" name="inTime" onblur="inTimeCheck();" placeholder="Enter In-Time"
							required="true" />
				</div>

				<div class="form-control-attendance">
					<label for="outTime">Out-Time : </label>
						<form:input path="outTime" name="outTime" onblur="outTimeCheck();" placeholder="Enter Out-Time"
							required="true" />
				</div>
