...
body {
	background-image:
		url(https://images.unsplash.com/photo-1508615039623-a25605d2b022?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80);
...
<body>
	...
	<form:form action="checkadminlogin" method="post"
		...
		<form:input id="adminpassword" path="adminPassword"
